...
public class MainActivity extends Activity {
		...
		findpeople.setOnClickListener(new OnClickListener() {
			...
			//	Intent myIntent = new Intent(view.getContext(),
				...
				//myIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK
						//| Intent.FLAG_ACTIVITY_CLEAR_TASK);
				//startActivityForResult(myIntent, 0);
				new AsyncGetOnlineMessageJson().execute();
	...
	private void initGetUserInformation(final TbMessage temp) {
		Log.d("tempGetUser= ",String.valueOf(temp.getId()));
	...
	private void initGetOnlineMessageJson() throws JSONException {

		ir.home.controller.json.MessageController controller = new ir.home.controller.json.MessageController();
		try {
			list = controller.ShowOnlineMessage(lastUpdate);
	...
	private class AsyncGetOnlineMessageJson extends
			AsyncTask<String, Void, Integer> {
		ProgressDialog pdLoading = new ProgressDialog(MainActivity.this);
